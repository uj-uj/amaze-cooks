...
<html lang="en">
  <head>
    ...
    />
    <title>Products - amaze cooks</title>
  ...
  <body>
    ...
    <section class="py-5 mt-5">
      <div class="filter-card">
        <div class="filter-button"><button>Search localy</button></div>
                ...
                <div class="reflow-product-list ref-cards">
                  <div class="ref-products">
                    <?php
                                    ...
                                    $sql = "SELECT id, name, location,rating_count FROM MyGuests";
                                    $result = $conn->query($sql); if
                    ($result->num_rows > 0) { // output data of each row
                    while($row = $result->fetch_assoc()) { echo "id: " .
                    $row["id"]. " - Name: " . $row["name"]. " " .
                    $row["location"]. "<br />"; } } else { echo "0 results"; }
                    $conn->close(); ?>
                    ...
                    <a class="ref-product" href="/product.html?product=43218622"
                      ...
                      <div class="ref-product-data">
                        <div class="ref-product-info">
                          <h5 class="ref-name">Dr. Darrion Grimes II</h5>
                          <p class="ref-excerpt">'.$row["name"].'</p>
                        </div>
                        <p class="ref-price">'.$row["location"].'</p>
                      </div>
                    </a>
                    ...
                    <a class="ref-product" href="/product.html?product=43218622"
                      ...
                      <div class="ref-product-data">
                        <div class="ref-product-info">
                          <h5 class="ref-name">Dr. Darrion Grimes II</h5>
                          <p class="ref-excerpt">
                            Hic quasi quam cupiditate aut non minus quae
                            necessitatibus.
                          </p>
                        </div>
                        <p class="ref-price">$762.74</p>
                      </div>
                    </a>
                  </div>
                </div>
